...
function Cgv() {
  return (
    <div className="cgv">
        ...
        <main className="cgv__container">
            <p className="cgv__text">Ce site web est exploité par WAA-AGROPRO. Sur ce site, les termes «nous», «notre» et «nos» font référence à WAA-AGROPRO propose ce site web, y compris toutes les informations, tous les outils et tous les services qui y sont disponibles pour vous, l’utilisateur, sous réserve de votre acceptation de l’ensemble des modalités, conditions, politiques et avis énoncés ici.</p>
            <h2 className="cgv__article">CONDITIONS GÉNÉRALES DE VENTE ET D’UTILISATION</h2>
            <h2 className="cgv__article">VUE D’ENSEMBLE</h2>
            <p className="cgv__text">Ce site web est exploité par WAA-AGROPRO. Sur ce site, les termes «nous», «notre» et «nos» font référence à WAA-AGROPRO. 
            <br />
            WAA-AGROPRO propose ce site web, y compris toutes les informations, tous les outils et tous les services qui y sont disponibles pour vous, l’utilisateur, sous réserve de votre acceptation de l’ensemble des modalités, conditions, politiques et avis énoncés ici.
            <br />
            ...
            <br />
            Notre boutique est hébergée sur OVH. 
            </p>
            <h2 className="cgv__article">ARTICLE 1 – CONDITIONS D’UTILISATION DE NOTRE BOUTIQUE EN LIGNE</h2>
            <p className="cgv__text">
            ...
            <h2 className="cgv__article">ARTICLE 2 – CONDITIONS GÉNÉRALES</h2>
            <p className="cgv__text">
            ...
            <h2 className="cgv__article">ARTICLE 3 – EXACTITUDE, EXHAUSTIVITÉ ET ACTUALITÉ DES INFORMATIONS</h2>
            <p className="cgv__text">
            ...
            <h2 className="cgv__article">ARTICLE 4 – MODIFICATIONS APPORTÉES AU SERVICE ET AUX PRIX</h2>
            <p className="cgv__text">
            ...
            <h2 className="cgv__article">ARTICLE 5 – PRODUITS OU SERVICES (le cas échéant)</h2>
            <p className="cgv__text">
            ...
            <h2 className="cgv__article">ARTICLE 6 – EXACTITUDE DE LA FACTURATION ET DES INFORMATIONS DE COMPTE</h2>
            <p className="cgv__text">
            ...
            <h2 className="cgv__article">ARTICLE 7 – OUTILS FACULTATIFS</h2>
            <p className="cgv__text">
            ...
            <h2 className="cgv__article">ARTICLE 8 – LIENS DE TIERS</h2>
            <p className="cgv__text">
            ...
            <h2 className="cgv__article">ARTICLE 9 – COMMENTAIRES, SUGGESTIONS ET AUTRES PROPOSITIONS D’UTILISATEURS</h2>
            <p className="cgv__text">
            ...
            <h2 className="cgv__article">ARTICLE 10 – RENSEIGNEMENTS PERSONNELS</h2>
            <p className="cgv__text">
            ...
            <h2 className="cgv__article">ARTICLE 11 – ERREURS, INEXACTITUDES ET OMISSIONS</h2>
            <p className="cgv__text">
            ...
            <h2 className="cgv__article">ARTICLE 12 – UTILISATIONS INTERDITES</h2>
            <p className="cgv__text">
            ...
            <h2 className="cgv__article">ARTICLE 13 – EXCLUSION DE GARANTIES ET LIMITATION DE RESPONSABILITÉ</h2>
            <p className="cgv__text">
            ...
            <h2 className="cgv__article">ARTICLE 16 – RÉSILIATION</h2>
            <p className="cgv__text">
            ...
            <h2 className="cgv__article">ARTICLE 17 – INTÉGRALITÉ DE L’ACCORD</h2>
            <p className="cgv__text">
            ...
            <h2 className="cgv__article">ARTICLE 18 – LOI APPLICABLE</h2>
            <p className="cgv__text">
            Ces Conditions Générales de Vente et d’Utilisation, ainsi que tout autre accord séparé par le biais duquel nous vous fournissons des Services seront régis et interprétés en vertu des lois en vigueur à 51 Audibert et Lavirotte 69008 Lyon
            </p>
            <h2 className="cgv__article">ARTICLE 19 – MODIFICATIONS APPORTÉES AUX CONDITIONS GÉNÉRALES DE VENTE ET D’UTILISATION</h2>
            <p className="cgv__text">
            ...
            <h2 className="cgv__article">ARTICLE 20 – COORDONNÉES</h2>
            <p className="cgv__text">Les questions concernant les Conditions Générales de Vente et d’Utilisation devraient nous être envoyées à contact@agroproannonce.com.</p>
        </main>
    </div>
  )
}
